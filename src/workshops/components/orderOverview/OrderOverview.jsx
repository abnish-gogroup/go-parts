...
function OrderOverview(props) {
  ...
  return (
    <div className={expanded ? 'main_container_checkout pd_240' : 'main_container_checkout pd_140'}>
      <ReportAProblemBox />
      <SelectedSupplier1 supplierId='(ID 1234 A)' supplierName='Nora Zentrum Wolfsburg' suppAddsName='Nora Zentrum Wolfsburg' suppCity='Wolfsburg, Niedersachsen , 38444' suppMobNo='05361 204181-0' supplierEmail='lieferung@teileservice.de' />
