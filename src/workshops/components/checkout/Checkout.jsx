...
function Checkout(props) {
  ...
  return (
    <div className={expanded ? 'main_container_checkout pd_240' : 'main_container_checkout pd_140'}>
      ...
      <SupplierDetails1 supplierName='Nora Zentrum Wolfsburg' suppAddsName='Nora Zentrum Wolfsburg' supplierCity='Wolfsburg, Niedersachsen , 38444' supplierPhoneNo='05361 204181-0' supplierEmail='lieferung@teileservice.de' radioBtnName='supp1_delivery' radioBtnTime='time1' />
